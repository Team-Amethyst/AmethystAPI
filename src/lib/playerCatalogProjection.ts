...
export const PLAYER_CATALOG_LEAN_SELECT =
  "mlbId catalogKind name team position positions age depthChartPosition injurySeverity catalog_rank catalog_tier adp tier value outlook projection" as const;
